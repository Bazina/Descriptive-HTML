...
static private int jjMoveNfa_0(int startState, int curPos)
{
   ...
   for (;;)
   {
      ...
      if (curChar < 64)
      {
         ...
         do
         {
            switch(jjstateSet[--i])
            {
               ...
               case 1084:
                  if (curChar == 34)
                     { jjCheckNAddTwoStates(1085, 1074); }
                  break;
               case 1085:
                  if ((0x7ffc00100000000L & l) != 0L)
                     { jjCheckNAddTwoStates(1085, 1074); }
               ...
               case 1096:
                  if (curChar == 34)
                     { jjCheckNAddTwoStates(1097, 1074); }
                  break;
               case 1097:
                  if ((0x7ffc00100000000L & l) != 0L)
                     { jjCheckNAddTwoStates(1097, 1074); }
               ...
               case 1126:
                  if (curChar == 34)
                     { jjCheckNAddTwoStates(1127, 1122); }
                  break;
               case 1127:
                  if ((0x7ffc00100000000L & l) != 0L)
                     { jjCheckNAddTwoStates(1127, 1122); }
               ...
               case 1137:
                  if (curChar == 34)
                     { jjCheckNAddTwoStates(1138, 1122); }
                  break;
               case 1138:
                  if ((0x7ffc00100000000L & l) != 0L)
                     { jjCheckNAddTwoStates(1138, 1122); }
               ...
               case 1149:
                  if (curChar == 34)
                     { jjCheckNAddTwoStates(1150, 1122); }
                  break;
               case 1150:
                  if ((0x7ffc00100000000L & l) != 0L)
                     { jjCheckNAddTwoStates(1150, 1122); }
               ...
               case 1172:
                  if (curChar == 34)
                     { jjCheckNAddTwoStates(1173, 1122); }
                  break;
               case 1173:
                  if ((0x7ffc00100000000L & l) != 0L)
                     { jjCheckNAddTwoStates(1173, 1122); }
               ...
               case 1184:
                  if (curChar == 34)
                     { jjCheckNAddTwoStates(1185, 1122); }
                  break;
               case 1185:
                  if ((0x7ffc00100000000L & l) != 0L)
                     { jjCheckNAddTwoStates(1185, 1122); }
               ...
               case 1197:
                  if ((0x3ff000000000000L & l) != 0L)
                     { jjCheckNAddTwoStates(1197, 1115); }
                  break;
               case 1198:
               case 1203:
                  if (curChar == 47)
               ...
               case 1232:
                  if (curChar == 34)
                     { jjCheckNAddTwoStates(1233, 1109); }
                  break;
               case 1233:
                  if ((0x7ffc00100000000L & l) != 0L)
                     { jjCheckNAddTwoStates(1233, 1109); }
               ...
               case 1244:
                  if (curChar == 34)
                     { jjCheckNAddTwoStates(1245, 1109); }
                  break;
               case 1245:
                  if ((0x7ffc00100000000L & l) != 0L)
                     { jjCheckNAddTwoStates(1245, 1109); }
      ...
      else if (curChar < 128)
      {
         ...
         do
         {
            switch(jjstateSet[--i])
            {
               ...
               case 1196:
                  if ((0x7fffffeL & l) != 0L)
                     { jjCheckNAddTwoStates(1196, 1115); }
                  break;
               case 1200:
                  if (curChar == 112)
      ...
      ++curPos;
      if ((i = jjnewStateCnt) == (startsAt = 1293 - (jjnewStateCnt = startsAt)))
         return curPos;
...
static final int[] jjnextStates = {
   25, 109, 195, 348, 206, 288, 289, 208, 286, 287, 207, 287, 209, 355, 361, 362, 
   357, 359, 360, 356, 360, 358, 776, 858, 859, 778, 856, 857, 777, 857, 779, 928, 
   1010, 1011, 930, 1008, 1009, 929, 1009, 931, 1221, 1222, 1114, 1196, 1197, 1116, 1194, 1195, 
   1115, 1195, 1117, 1082, 1094, 1105, 1230, 1242, 1253, 1265, 1278, 1290, 917, 1069, 679, 764, 
   510, 593, 406, 426, 350, 385, 7, 8, 79, 91, 102, 44, 56, 67, 163, 175, 
   186, 128, 140, 151, 321, 333, 344, 294, 300, 207, 208, 209, 262, 274, 285, 227, 
   239, 250, 207, 286, 209, 367, 373, 356, 357, 358, 356, 359, 358, 389, 390, 409, 
   410, 481, 493, 504, 446, 458, 469, 564, 576, 587, 529, 541, 552, 648, 660, 671, 
   613, 625, 636, 733, 745, 756, 698, 710, 721, 891, 903, 914, 864, 870, 777, 778, 
   779, 832, 844, 855, 797, 809, 820, 777, 856, 779, 1043, 1055, 1066, 1016, 1022, 929, 
   930, 931, 984, 996, 1007, 949, 961, 972, 929, 1008, 931, 1202, 1208, 1115, 1116, 1117, 
   1170, 1182, 1193, 1135, 1147, 1158, 1115, 1194, 1117, 1230, 1242, 1253, 1256, 1257, 1268, 1269, 
   1281, 1282, 
};
...
static final long[] jjtoMore = {
   0x0L, 
    ...
    static private final int[] jjrounds = new int[1293];
    static private final int[] jjstateSet = new int[2 * 1293];
