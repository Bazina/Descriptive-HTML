package Parser;/* Parser.HTMLParserTokenManager.java */
/* Generated By:JavaCC: Do not edit this line. Parser.HTMLParserTokenManager.java */
...
static private int jjMoveStringLiteralDfa0_0(){
   ...
   {
      case 34:
         return jjStartNfaWithStates_0(0, 13, 1120);
      case 61:
...
static private int jjMoveNfa_0(int startState, int curPos)
{
   ...
   for (;;)
   {
      ...
      if (curChar < 64)
      {
         ...
         do
         {
            switch(jjstateSet[--i])
            {
               ...
               case 1022:
                  if (curChar == 34)
                     { jjCheckNAddTwoStates(1023, 1001); }
                  break;
               case 1023:
                  if ((0xfffffffbffffffffL & l) != 0L)
                     { jjCheckNAddTwoStates(1023, 1001); }
               ...
               case 1033:
                  if (curChar == 34)
                     { jjCheckNAddTwoStates(1034, 1001); }
                  break;
               case 1034:
                  if ((0xfffffffbffffffffL & l) != 0L)
                     { jjCheckNAddTwoStates(1034, 1001); }
               ...
               case 1045:
                  if (curChar == 34)
                     { jjCheckNAddTwoStates(1046, 1001); }
                  break;
               case 1046:
                  if ((0xfffffffbffffffffL & l) != 0L)
                     { jjCheckNAddTwoStates(1046, 1001); }
      ...
      ++curPos;
      if ((i = jjnewStateCnt) == (startsAt = 1135 - (jjnewStateCnt = startsAt)))
         return curPos;
      try { curChar = input_stream.readChar(); }
...
static final int[] jjnextStates = {
   1118, 1119, 1120, 21, 105, 191, 320, 972, 984, 995, 1020, 1031, 1043, 1054, 1066, 1079, 
   1091, 1116, 831, 959, 617, 702, 448, 531, 344, 364, 1128, 1134, 3, 4, 75, 87, 
   98, 40, 52, 63, 159, 171, 182, 124, 136, 147, 282, 293, 305, 316, 268, 274, 
   225, 236, 248, 259, 211, 217, 327, 328, 347, 348, 419, 431, 442, 384, 396, 407, 
   502, 514, 525, 467, 479, 490, 586, 598, 609, 551, 563, 574, 671, 683, 694, 636, 
   648, 659, 794, 805, 817, 828, 780, 786, 737, 748, 760, 771, 723, 729, 922, 933, 
   945, 956, 908, 914, 865, 876, 888, 899, 851, 857, 1006, 1012, 1057, 1058, 1069, 1070, 
   1082, 1083, 1102, 1108, 1096, 1097, 1122, 1123, 
};
...
static final long[] jjtoMore = {
   0x0L, 
    ...
    static private final int[] jjrounds = new int[1135];
    static private final int[] jjstateSet = new int[2 * 1135];
