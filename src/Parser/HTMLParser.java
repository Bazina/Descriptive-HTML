package Parser;/* Parser.HTMLParser.java */
/* Generated By:JavaCC: Do not edit this line. Parser.HTMLParser.java */
...
public class HTMLParser implements HTMLParserConstants {
  ...
  public static void main(String args[]) throws ParseException {
    HTMLParser parser = new Parser.HTMLParser(System.in);
    String ans = parser.Input();
    System.out.println(ans);
  }

  static final public String Input() throws ParseException, NumberFormatException {Parser.Token t;
...
String str = t.image;
                ...
                if (t.image.contains("IMAGE")) {
                    ...
                    if (tag.equals("a") && (text.equals("") || link.equals(""))) {
                        System.out.println("Error: Link and text cannot be empty");
                        System.exit(0);
                    }
...
System.out.println("Parse error at " + e.currentToken.next.beginLine + ":" + e.currentToken.next.beginColumn);
            System.exit(1);
      }
    }
    jj_consume_token(27);
{if ("" != null) return ans.toString();}
  ...
  static private boolean jj_3_1()
 {
  ...
  static public HTMLParserTokenManager token_source;
